...
(function () {
  ...
  function darkMode() {
    ...
    document.querySelector('.navbar-toggler-icon').classList.add('white');
    document.querySelector('.navbar-toggler-icon').classList.remove('black');
  ...
  function lightMode() {
    ...
    document.querySelector('.navbar-toggler-icon').classList.add('black');
    document.querySelector('.navbar-toggler-icon').classList.remove('white');
